...
def main():
    ...
    source_env = platform.Environment(some_url=args.url, some_token=args.token, cert_file=args.clientCert)
    params = vars(args)
    ...
    try:
        ...
        if target_url is None and target_key is None and source_branch is None and target_branch is None:
            ...
            target_env = platform.Environment(some_url=args.urlTarget, some_token=args.tokenTarget, cert_file=args.clientCert)
