...
def test_search_issues_by_project() -> None:
    ...
    nb_issues = len(issues.Issue.search_by_project(endpoint=tutil.SQ, project_key=tutil.LIVE_PROJECT, params={"resolved": "false"}))
    assert nb_issues < 1800
    nb_issues = len(issues.Issue.search_by_project(endpoint=tutil.SQ, project_key=None))
