...
class User(sqobject.SqObject):
    ...
    def __init__(self, endpoint: Platform, login: str, data: types.ApiPayload) -> None:
    ...
    @classmethod
    def load(cls, endpoint: Platform, data: types.ApiPayload) -> User:
    ...
    @classmethod
    def create(cls, endpoint: Platform, login: str, name: str, is_local: bool = True, password: str = None) -> User:
...
def search(endpoint: Platform, params: types.ApiParams = None) -> dict[str, User]:
