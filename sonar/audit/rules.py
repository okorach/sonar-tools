...
class RuleId(enum.Enum):
    ...
    PERM_MAX_USERS_OR_GROUPS = 1100
    PERM_MAX_ADM_USERS_OR_GROUPS = 1101
    ...
    SONAR_USERS_ELEVATED_PERMS = 1205
    ...
    PROJ_TOO_MUCH_NEW_CODE = 1318
    PROJ_NON_COMPLIANT_KEY_PATTERN = 1319
    ...
    TOKEN_LIFETIME_UNLIMITED = 4004
    TOKEN_LIFETIME_TOO_HIGH = 4005
    TOKEN_EXPIRED = 4006
    USER_UNUSED = 4010
    USER_EXCESSIVE_NBR_OF_TOKENS = 4011
