...
'''
import sys
from sonar import env, version, settings, devops, projects, qualityprofiles, qualitygates, portfolios
...
def main():
    ...
    print(util.json_dump({'platform': platform_settings, 'projects': project_settings, 'portfolios': portfolio_settings}))
