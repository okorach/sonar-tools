...
class SqObject(object):
    ...
    def api_for(cls, op: str, endpoint: object) -> Optional[str]:
        ...
        This function must be overloaded for classes that need speficific treatment
        e.g. API V1 or V2depending on SonarQube vcersion, different API for SonarCloud
        """
