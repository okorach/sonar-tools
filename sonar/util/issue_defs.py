...
TYPE_DEPENDENCY_RISK = "DEPENDENCY_RISK"
TYPE_NONE = "NONE"

SCA_TYPE_VULNERABLE_DEPENDENCY = "VULNERABLE_DEPENDENCY"
SCA_TYPE_PROHIBITED_LICENCE = "PROHIBITED_LICENCE"
SCA_TYPE_MALWARE = "MALWARE"
SCA_RISK_TYPES = (SCA_TYPE_VULNERABLE_DEPENDENCY, SCA_TYPE_PROHIBITED_LICENCE, SCA_TYPE_MALWARE)
SCA_API_TYPE_MAPPING = {
    "VULNERABILITY": SCA_TYPE_VULNERABLE_DEPENDENCY,
    "PROHIBITED_LICENSE": SCA_TYPE_PROHIBITED_LICENCE,
    "MALWARE": SCA_TYPE_MALWARE,
}
...
STATUSES = ("OPEN", "CONFIRMED", "REOPENED", "RESOLVED", "CLOSED", "ACCEPTED", "FALSE_POSITIVE", "IN_SANDBOX")
